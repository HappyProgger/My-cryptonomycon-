        ...
        <div class="container">
          ...
          v-if="pageCurent < getPageCount()"
            ...
            <input
                    ...
                    @change="getListOfCoins() ; this.pageCurent = 1"
                    v-model = "filterValue"
                    type="text"
                    name="wallet"
                    id="filter"
  ...
  export default{
    ...
    methods :{
      ...
      filteredTickers(){
        ...
        // console.log(start)
        // console.log(end)
        // console.log(this.tickers.slice(start,end))
        // this.pageCount =  Math.ceil(this.tickers.filter( el => el.tickName.toLowerCase().indexOf(this.filterValue.toLowerCase()) >= 0 )
